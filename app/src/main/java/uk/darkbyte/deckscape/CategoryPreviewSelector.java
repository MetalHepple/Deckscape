...
/** Selects a deterministic representative wallpaper for each directory card. */
final class CategoryPreviewSelector {
    private CategoryPreviewSelector() {}

    /** Returns the listed items with the best available descendant attached to each directory. */
